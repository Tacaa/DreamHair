...
@Entity
@Table(name = "preparations_regenerator")
public class PreparationsRegenerator {
	@Id
	...
	@ManyToOne
	@JoinColumn(name = "regenerator_id")
	private Regenerator regenerator;
	
	@Column(name = "deleted")
	private Boolean deleted;

	public PreparationsRegenerator() {
		super();
	}
	...
	public void setRegenerator(Regenerator regenerator) {
